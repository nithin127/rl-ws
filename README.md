...
```bash
./djinn exec lab "./isaaclab.sh -p -m pip install -e biped/exts/bipedal_locomotion biped/himloco"
./djinn exec lab "./isaaclab.sh -p -m pip install plotly dash openpyxl"
```
